    ...
    def sample(self) -> DrawAndLogP:
        ...
        for k in range(self._max_proposals):
            ...
            try:
                ...
                print(f"Error evaluating log density at {self._theta}, rejecting proposed draw\n", e)
            ...
            if k == 0:
                self._accept1 = accept_logp  # diagnostic
            if k == 1:
                self._accept2 = accept_logp
            if k == 2:
                self._accept3 = accept_logp
            if k == 3:
                self._accept4 = accept_logp
                
            accept_logp = -np.inf # always reject proposal
    ...
    def accept(
        ...
        for i in range(k):
            try:
                ...
                print(f"Error evaluating log density at {theta_prop}, rejecting ghost draw\n", e)
                self._ghost_nans += 1  # diagnostic
                self._hastings = prop_hastings - cur_hastings
