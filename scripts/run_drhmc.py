...
from src.utils.nuts_utils import get_nuts_step_size, get_nuts_metric, get_nuts_step_counts
...
def configure_sampler(sampler, posterior):
    ...
    if sampler.params.step_count_factor:
        ...
        init_step_count = sampler.params.step_count
...
def run_sampler(sampler, config):
    ...
    thin_counter = -1 # sptart at -1 to ensure first draw is not thinned
